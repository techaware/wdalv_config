...
col_delete_02                   type ztalv_columns-col_delete,
  ...
  constants C_ORIGINAL_CONFIG type SALV_WD_CONSTANT value '01'. "#EC NOTEXT
  constants C_WRAPPER_CONFIG type SALV_WD_CONSTANT value '02'. "#EC NOTEXT
  constants C_ZALV_COMP_NAME type WDY_COMPONENT_NAME value 'ZALV'. "#EC NOTEXT
  constants C_ALV_COMP type WDY_COMPONENT_NAME value 'SALV_WD_TABLE'. "#EC NOTEXT
  constants C_FUNCTION_RECORD_COUNT type STRING value 'ZALV_COUNT'. "#EC NOTEXT
  constants C_FUNCTION_FULL_SCREEN type STRING value 'ZALV_FULL'. "#EC NOTEXT
  constants C_FUNCTION_EXPORT type STRING value 'ZALV_EXPOR'. "#EC NOTEXT
